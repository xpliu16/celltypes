dataFolder = "/Users/xiaoping.liu/celltypes/MTG_anal"
...
sparse.pca.result  <-  spca(df, K = ncomp, para=rep(600, ncomp), type = "predictor", sparse=c("penalty"), lambda=1e-6)
...
arrow::write_feather(
  ...
  file.path(dataFolder, 'spca_19comps.feather')
)
